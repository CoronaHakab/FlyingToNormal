...
pre_symptomatic = MedicalState(name="pre-symptomatic", length_pv=pre_symptomatic_length_pv, contagious_factor=0.25, tests_pd=0.7, next_state=None)
...
latent = MedicalState(name="latent", length_pv=latent_length_pv, contagious_factor=0, tests_pd=0.7, next_state=pre_symptomatic)
